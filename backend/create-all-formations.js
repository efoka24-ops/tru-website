/**
 * Script pour créer toutes les formations TRU GROUP
 * Exécuter avec: node create-all-formations.js
 */
...
const certificatsFormations = [
  {
    ...
    modules: [
      ...
      "Gestion des actifs et menaces",
      "Examen de certification Google"
    ],
    places_disponibles: 25,
    statut: "active",
  ...
  },
  {
    ...
    modules: [
      ...
      "Visualisation avec Tableau",
      "Programmation R",
      "Projet Capstone et certification"
    ],
    places_disponibles: 30,
    statut: "active",
  ...
  },
  {
    ...
    lieu: "Yaoundé / En ligne",
    modules: [
      "Principes du support technique",
  ...
  },
  {
    ...
    lieu: "Formation en ligne",
    modules: [
      "Fondamentaux du UX Design",
      "Recherche utilisateur",
      "Wireframes et prototypes",
      "Design haute fidélité",
      "Tests utilisateurs",
      "Portfolio et certification Google"
    ],
    places_disponibles: 20,
    statut: "active",
  ...
  },
  {
    ...
    modules: [
      ...
      "Excel pour analysts",
      "Certification IBM Data Analyst"
    ],
    places_disponibles: 25,
    statut: "active",
  ...
  },
  {
    ...
    modules: [
      ...
      "Python et bibliothèques (Pandas, NumPy)",
  ...
  try {
    const response = await fetch(`${API_URL}/formations`, {
      ...
      headers: {
        ...
        'Authorization': `Bearer ${process.env.AUTH_TOKEN || 'admin-token-here'}`
      },
    ...
    console.error(`❌ Erreur pour "${formation.titre}":`, error.message);
    return null;
  }
}

// Fonction pour créer toutes les formations avec un délai
async function createAllFormations() {
  console.log('🚀 Démarrage de la création des formations...\n');
  console.log(`📚 Total: ${competencesFormations.length + certificatsFormations.length} formations\n`);
  ...
  for (const formation of competencesFormations) {
    ...
    // Attendre 500ms entre chaque création pour éviter de surcharger l'API
  ...
  console.log('\n' + '='.repeat(50));
  console.log(`\n✅ Formations créées avec succès: ${successCount}`);
...
export { createAllFormations, competencesFormations, certificatsFormations };
